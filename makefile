...
_OBJ = xterm_display.o shadowcast.o scene.o movementsystem.o tilesystem.o playersystem.o aisystem.o tile.o entitystack.o visibilitysystem.o terrainsystem.o
